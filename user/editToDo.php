...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php">
                ...
                <div class="sidebar-brand-text mx-3">GDA <sup>2</sup></div>
            </a>
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form
                        ...
                        <div class="input-group">
                            Welcome <b class="ml-2"><?php echo $session_user_name; ?></b>
                        </div>
                    </form>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $session_user_name; ?></span>
    ...
    <!-- Modal Add TO DO -->
    <div class="modal fade" id="addToDoModal" tabindex="-1" role="dialog" aria-labelledby="addToDoModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
        <form action="" method="POST">
            <div class="modal-header">
                <h5 class="modal-title" id="addToDoModal">Add New Todo</h5>
            ...
            <div class="modal-body">
                    <div class="form-group">
                        <input type="text" class="form-control" name="ToDoTitleInput" id="ToDoTitleInput" placeholder="Enter Title">
                    </div>
                    <div class="form-group">
                        <input type="date" class="form-control" name="ToDoDateInput" id="ToDoDateInput" placeholder="Enter Date">
                    </div>
                    <div class="form-group">
                        <textarea class="form-control" id="ToDoDesc" name="ToDoDesc" placeholder="Enter Desc..." rows="3"></textarea>
                    </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="submit" name="submitToDo" class="btn btn-primary">Save changes</button>
            </div>
        </form>
        </div>
    </div>
